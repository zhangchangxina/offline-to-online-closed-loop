...
# Usage: bash experiments/scripts/pipelines/run_carla_pipeline.sh <GPU_ID>
...
# CARLA defaults (autonomous driving)
ENV_ID="carla-lane-v0"
SEED=0
SAVE_ROOT="/media/nudt3090/XYQ/ZCX/WSRL/wsrl_log"
PROJECT_DIR="wsrl"

# CARLA recommended scaling (driving rewards)
R_SCALE=1.0
R_BIAS=0.0
